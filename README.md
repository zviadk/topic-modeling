This topic modeling project performs daily news scrapping of news website agenda.ge into a dataframe for a given period and then caries out clustering of the news items into topics.  
