This topic modeling project performs daily news scraping of news website agenda.ge into a dataframe for a given period and then clustering of the data into topics.  
